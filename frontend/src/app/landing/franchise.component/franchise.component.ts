...
states: string[] = [
 ...
 "Andhra Pradesh": [
    ...
    "Arunachal Pradesh": [
      ...
      "Lower Dibang Valley", "Dibang Valley", "Lohit", "Namsai", "Anjaw",
    ...
    "Punjab": [
      ...
      "Patiala", "Rupnagar", "Sangrur", "Shaheed Bhagat Singh Nagar",
      "Tarn Taran"
    ],
 ...
 ngOnInit(): void {
    this.franchiseForm = this.fb.group({
      ...
      landSpace: ['', Validators.required],
      investmentRange: ['', Validators.required],
      address: ['', Validators.required],
      businessExperience: ['', Validators.required]
    });
  
    this.franchiseForm.get('state')?.valueChanges.subscribe(state => {
      this.filteredDistricts = this.districts[state] || [];
      this.franchiseForm.get('district')?.reset();
    });
  }

  onStateChange(): void {
    const state = this.franchiseForm.get('state')?.value;
    this.filteredDistricts = this.districts[state] || [];
    this.franchiseForm.get('district')?.reset();
  }
 onCancel(): void {
  ...
  onSubmit(): void {
    ...
    console.log('Form Submitted:', this.franchiseForm.value);
}
}
